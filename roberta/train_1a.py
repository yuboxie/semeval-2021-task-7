...
log_path = 'log/roberta_large_1a_5e-6.txt'
save_path = 'checkpoints/roberta_large_1a_5e-6'
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        print('Val Num {} Loss {:.4f} P {:.4f} R {:.4f} F {:.4f} Acc {:.4f}'.format(
            len(y_pred), np.mean(val_loss), p, r, f, acc))
