...
restore_path = 'checkpoints/bert_base_1a_5e-6'
optimal_epochs = {'bert-base-cased': 8, 'bert-large-cased': 10}
...
if __name__ == '__main__':
    ...
    # pd.DataFrame({'id': ids_test, 'is_humor': y_pred_test}).to_csv(
    #     'test_results/1a_{:02d}.csv'.format(restore_epoch), index = False)
